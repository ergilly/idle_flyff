...
export function SelectedItemDescription({ item }) {
  ...
  async function getClass() {
    ...
    if (item.class) {
      ...
      return setClassName(result.data().name.en)
    }
    return null
  }
  ...
  return (
    <div className="flex flex-col m-1 p-4 bg-gray-600 border-0 rounded-lg w-3/4 h-min">
      ...
      {item.description.en !== undefined && item.description.en !== 'null' && (
        <span className="text-gray-100">
